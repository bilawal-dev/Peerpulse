// app/employee/dashboard/performance-report/page.tsx
"use client";
...
export default function DashboardPerformanceReportPage() {
                        ...
                        <Card key={cycle.review_cycle_id} className="bg-white shadow-sm">
                            ...
                            <div className="px-6 pb-4">
                                {cycle.is_review_enabled ? (
                                    <Link
                                        href={`/employee/dashboard/performance-report/${cycle.review_cycle_id}`}
                                    >
                                    ...
                                    <Button
                                        ...
                                        onClick={() =>
                                            toast.error("Performance report is not enabled by Company")
                                        }
                                    >
                                        Report Disabled
                                    </Button>
