...
const steps = [
    {
        ...
        actionHref: "/employee/dashboard/peer-selection",
        actionTarget: "_self",
    },
    {
        number: 2,
    ...
    },
    {
        ...
        actionHref: "/employee/dashboard/review-form",
        actionTarget: "_blank",
    },
    {
        number: 4,
    ...
    return (
        <div className="space-y-8 pb-8">
            ...
            <Card>
                <CardContent className="flex flex-col gap-4 pt-5">
                    ...
                    <p className="text-gray-700">
                        Empower your growth with Elevu's streamlined peer review process.
                        Follow the steps below to complete your reviews and help your team thrive.
                    </p>
                </CardContent>
            </Card>
            ...
            <div className="relative border-l-2 border-blue-600 ml-5 pl-6">
                {steps.map(({ number, title, description, Icon, actionLabel, actionHref, actionTarget }, i) => (
                    <div key={i} className="mb-12 last:mb-0 relative">
                        ...
                        <p className="text-sm sm:text-base text-gray-700 mb-3 max-w-xl">{description}</p>
