...
import { PlusCircle, Trash2, Home, User, LogOut, Calendar, Users, BarChart3, Settings, Key, Eye, EyeOff } from "lucide-react";
...
export default function AdminDashboardRootPage() {
    ...
    async function handleChangePassword() {
        ...
        try {
            await changePassword(passwordFormData.currentPassword, passwordFormData.newPassword, "company");
